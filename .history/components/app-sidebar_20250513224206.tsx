...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="border-r border-border/20 shadow-sm font-outfit">
      <div className="flex h-14 items-center border-b border-border/20 px-4 shadow-sm">
      ...
      <div className="border-t border-border/20 p-4 shadow-sm">
