    ...
    <div className="space-y-6 font-outfit">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link href="/dashboard/departments">
          <Card className="hover:shadow-md transition-all duration-200 border-neutral-200/10 dark:border-neutral-800/10 hover:border-neutral-200/20 dark:hover:border-neutral-800/20">
