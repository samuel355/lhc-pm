        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {projects.map((project) => {
            ...
            return (
              <Card 
                key={project.id} 
                className="hover:shadow-lg transition-all duration-300 cursor-pointer border-border bg-card hover:border-primary/20"
              >
                <CardContent className="p-4">
                  <div className="flex justify-between items-start">
                    ...
                    <Badge 
                      ...
                      className={progress === 100 ? "bg-primary text-primary-foreground" : ""}
                    >
